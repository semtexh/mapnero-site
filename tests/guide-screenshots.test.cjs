...
for (const topic of ['quick-start', 'import-map', 'team-gnss', 'measure-cogo-buffer', 'location-track']) test(`all twelve ${topic} captures are distinct full-resolution PNG files`, () => {
